...
export const metadata: Metadata = {
  title: {
    absolute:
      "Barnegat NJ Junk Removal | Fast, Affordable | Ocean County Junk Removal",
  },
  description: DESCRIPTION,
  openGraph: {
    title: "Barnegat NJ Junk Removal | Fast, Affordable",
    description: DESCRIPTION,
...
export default function BarnegatPage() {
  return (
    <LocationPage
      ...
      localNote="As Barnegat&rsquo;s trusted junk removal service, the job we run most often here is the estate cleanout. A lot of long-held family homes are changing hands right now, and we can empty a full house in a day, with anything usable donated rather than dumped. We also cover the bayfront streets, the Barnegat Lake neighborhoods, and Barnegat Light across the bridge on LBI."
