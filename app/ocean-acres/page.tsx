...
export const metadata: Metadata = {
  title: {
    absolute:
      "Junk Removal Ocean Acres NJ | Fast, Affordable | Ocean County Junk Removal",
  },
  description: DESCRIPTION,
  openGraph: {
    title: "Junk Removal Ocean Acres NJ | Fast, Affordable",
    description: DESCRIPTION,
