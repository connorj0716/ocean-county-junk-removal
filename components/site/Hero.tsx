...
export default function Hero() {
  return (
    <section className="relative overflow-hidden text-white min-h-screen flex items-center" style={{ background: "linear-gradient(to right, #0f2580 0%, #0f2580 40%, #f47820 100%)" }}>
      <div
        aria-hidden
