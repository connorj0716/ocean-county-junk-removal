...
export default function Hero() {
  return (
    <section className="relative overflow-hidden text-white min-h-screen flex items-center" style={{ background: "linear-gradient(135deg, #08184f 0%, #0f2580 30%, #c45e0a 60%, #a34a05 100%)" }}>
      <div
        aria-hidden
